...
int main(){
    ...
    data_loader.Dump_Gray(w1, h1, pixels1, string("output/step1_img_0.jpg"));
    data_loader.Display_Gray_X_Server(w1, h1, pixels1);
    data_loader.Display_Gray_ASCII(w1, h1, pixels1);
    data_loader.Display_Gray_CMD("output/step1_img_0.jpg");
    ...
    data_loader.Dump_RGB(w3, h3, pixels3, string("output/step1_airplane_0010.jpg"));
    data_loader.Display_RGB_X_Server(w3, h3, pixels3);
    data_loader.Display_RGB_ASCII(w3, h3, pixels3);
    data_loader.Display_RGB_CMD("output/step1_airplane_0010.jpg");
